...
def main():
    ...
    clf = svm_classifier(reduced_train_feat, mnist.train.labels)
    ...
    print("\nDo classification using SVM classifier ")
    accuracy = perform_classification(reduced_train_feat, mnist.train.labels, reduced_test_feat, mnist.test.labels)
